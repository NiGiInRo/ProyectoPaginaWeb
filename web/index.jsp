    ...
    <div id="header">
      <div id="logo">
        <div id="logo_text">
          ...
          <h1><a href="index.jsp">LAW.WEB</span></a></h1>
          <h2>TODOS LOS PROCESOS PARA TODOS LOS ABOGADOS</h2> 
        </div>
      ...
      <div id="menubar">
        <ul id="menu">
          ...
          <li><a href="PerfilUsuario.jsp">ENTRAR COMO ADMINISTRADOR</a></li>
